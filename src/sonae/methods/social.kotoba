(ns sonae.methods.social
  "social.cljc — 備え — Civilian Pre-Disaster Foresight + Preparedness + Early-Warning DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from sonae's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "備え — Civilian Pre-Disaster Foresight + Preparedness + Early-Warning が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over sonae's own domain (Non-profit religious-corp civilian PRE-disaster substrate: prevention / mitigation / preparedness / early warning. The 'before' half of the…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "sonae R0: live social posting is Council Lv6+ + operator + "
