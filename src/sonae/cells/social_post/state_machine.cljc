(ns sonae.cells.social-post.state-machine
  "Phase state machine for the 備え — Civilian Pre-Disaster Foresight + Preparedness + Early-Warning social_post cell — the publication membrane that
