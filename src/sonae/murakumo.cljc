...
(defn collection
  [name]
  (str "com.etzhayyim.sonae." name))

(def cell-specs {
  :hazard_watch {:legacy-cell "hazard-watch"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "hazard_watch")]
     :required-gates common-gates
     :trigger "manifest cell hazard_watch"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :risk_assessment {:legacy-cell "risk-assessment"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "risk_assessment")]
     :required-gates common-gates
     :trigger "manifest cell risk_assessment"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :early_warning_relay {:legacy-cell "early-warning-relay"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "early_warning_relay")]
     :required-gates common-gates
     :trigger "manifest cell early_warning_relay"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :preparedness_plan {:legacy-cell "preparedness-plan"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "preparedness_plan")]
     :required-gates common-gates
     :trigger "manifest cell preparedness_plan"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :drill_attestation {:legacy-cell "drill-attestation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "drill_attestation")]
     :required-gates common-gates
     :trigger "manifest cell drill_attestation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :handoff_trigger {:legacy-cell "handoff-trigger"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "handoff_trigger")]
     :required-gates common-gates
     :trigger "manifest cell handoff_trigger"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
